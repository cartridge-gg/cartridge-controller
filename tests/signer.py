...
class WebauthnSigner():
    ...
    def sign_transaction(self, contract_address, calls, nonce, max_fee):
        build_calls = []
        for call in calls:
        ...
        challenge_bytes = transaction_hash.to_bytes(
            32, byteorder="big")
        ...
        client_data_json = f"""{{"type":"webauthn.get","challenge":"{challenge}","origin":"{self.origin}","crossOrigin":false}}"""
